...
**Architect** build it for you. The same code runs against Anthropic, OpenAI, Gemini, Bedrock or a
model on your own machine, and anything you build can be served behind an OpenAI-compatible API.
